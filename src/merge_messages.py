...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='报文合并工具 - 合并ADS-B和雷达报文文件',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='''
示例:
  %(prog)s adsb.a3h radar.a3h merged.a3h
  %(prog)s adsb.a3h radar.a3h merged.a3h --date 2026-02-04
  %(prog)s adsb.a3h radar.a3h merged.a3h -v
'''
    )
